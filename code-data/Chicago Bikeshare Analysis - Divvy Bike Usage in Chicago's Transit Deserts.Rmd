...
4) What happens with older station ridership when new stations openup nearby (use size and color to show change)
5) busrouts for l trains and buses. There is a n ST function for width around lines. Make a map around rea that is not a distance around a certain point. (every bustop has a point). ST_buffer (look this up). could fill in the buffer area with colors. If I could get the l lines and shape. Could show that these are the areas within walking distance of an l station .
...
#  scale_fill_viridis_c(name = bikeshare_colors) +
  ...
  labs(title = "Community Areas Grouped by Chicago Side'",
...
###Plot 2: Usage fluxuation by weekday
