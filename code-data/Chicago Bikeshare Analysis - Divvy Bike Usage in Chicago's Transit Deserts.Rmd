...
divvy_date %>%
  ...
  theme(axis.line = element_line(size = 0.05), 
        ...
        legend.background = element_rect(fill = "#E5E1DF", color = "black", size = 0.1),
        panel.background = element_rect(fill = "#EFEBEA", colour = NA),
        strip.background = element_rect(fill = "red", colour = NA),
plot.background = element_rect(colour = "white", fill = "#EFEBEA", size = 1),
