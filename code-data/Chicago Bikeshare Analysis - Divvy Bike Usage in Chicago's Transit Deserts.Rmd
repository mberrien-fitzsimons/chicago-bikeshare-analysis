...
#    legend.position = "bottom") +
  labs(title = "Chicago Divvy bike station openings",
...
#  opts(legend.key.height=unit(3,"line"))
...
I'd instead argue for stations on the x-axis, divvy trip time on the y-axis, and time labeling each of the two dots. A small directed scatterplot, could really improve this visualization.
